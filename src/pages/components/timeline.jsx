            ...
            <div className="w-full max-w-3xl mx-auto">
              <div className="-my-6">
                ...
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="text-slate-500">Ends at 11:59 pm 14 Oct,2024</div>
                </div>
                ...
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="text-slate-500">
                    ...
                    Ends at 11:59 pm of 15th Oct,2024{" "}
                  </div>
                </div>
                ...
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="text-slate-500">
                    Ends at 8:00 am of 16th Oct,2024
                  </div>
                </div>
                ...
                <div className="relative pl-8 sm:pl-32 py-6 group">
                  ...
                  <div className="text-slate-500">Ends at 8:00 am 18th Oct,2024</div>
                </div>
