          ...
          <div className="flex flex-wrap text-center"> {/* Adjusted margin here */}
            ...
            <div className="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
              <div className="flex items-center justify-between p-4 rounded-lg bg-white shadow-indigo-50 shadow-md">
                <div>
                  ...
                  <h3 className="mt-2 text-xl font-bold text-green-500 text-left">&#8377;11,000</h3>
                </div>
            ...
            <div className="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
              <div className="flex items-center justify-between p-4 rounded-lg bg-white shadow-indigo-50 shadow-md">
                <div>
                  <h2 className="text-gray-900 text-lg font-bold">Total Money</h2>
                  <h3 className="mt-2 text-xl font-bold text-cyan-500 text-left">&#8377;6,500</h3>
                </div>
            ...
            <div className="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
              <div className="flex items-center justify-between p-4 rounded-lg bg-white shadow-indigo-50 shadow-md">
                <div>
                  <h2 className="text-gray-900 text-lg font-bold">Total Money</h2>
                  <h3 className="mt-2 text-xl font-bold text-indigo-500 text-left">&#8377;3,500 </h3>
                </div>
